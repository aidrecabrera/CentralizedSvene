...
public class OperatorStructuresController {

    double x, y;

    @FXML
    void visitTask1(ActionEvent event) throws URISyntaxException, IOException {
        Desktop.getDesktop().browse(new URI("https://classroom.google.com/u/1/c/NDUxODkwNzkxMTEx/a/NDY1NTgzMDU4OTU5/details"));
    }
